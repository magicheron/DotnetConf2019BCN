...
using DotnetConf2019BCN.ImageClassification.Train.DataModels;
using Microsoft.ML;
using Microsoft.ML.Transforms;
using static Microsoft.ML.DataOperationsCatalog;
using System.Linq;
using Microsoft.ML.Data;
using DotnetConf2019BCN.ImageClassification.Train.Common;

namespace DotnetConf2019BCN.ImageClassification.Train
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            var outputMlNetModelFilePath = Path.Combine(assetsPath, "outputs", "CookiesClassifier.zip");
            string imagesFolderPathForPredictions = Path.Combine(assetsPath, "inputs", "images-for-predictions", "CookiesForPredictions");

            string imagesDownloadFolderPath = Path.Combine(assetsPath, "inputs", "images");

            // 1. Seth the image path
            string fullImagesetFolderPath = assetsPath;
