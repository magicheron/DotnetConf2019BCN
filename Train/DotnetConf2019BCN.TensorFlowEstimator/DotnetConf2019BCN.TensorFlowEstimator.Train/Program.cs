...
using DotnetConf2019BCN.TensorFlowEstimator.Train.Model;
using DotnetConf2019BCN.TensorFlowEstimator.Train.Common;
using System.Collections.Generic;
using DotnetConf2019BCN.TensorFlowEstimator.Train.DataModels;

namespace DotnetConf2019BCN.TensorFlowEstimator.Train
{
    public class Program
    {
        static void Main(string[] args)
        {
            string assetsRelativePath = @"../../../../../../ProductImages";
            string modelAssetsRelativePath = @"../../../assets";
            string assetsPath = GetAbsolutePath(assetsRelativePath);
            string modelAssetsPath = GetAbsolutePath(modelAssetsRelativePath);

            //Inception v3
            var inceptionPb = Path.Combine(modelAssetsPath, "inputs", "tensorflow-pretrained-models", "inception-v3", "inception_v3_2016_08_28_frozen.pb");
            ...
            var imageClassifierZip = Path.Combine(modelAssetsPath, "outputs", "CookiesClassifier.zip");
            ...
            var fullImagesetFolderPath = assetsPath;// Path.Combine(imagesDownloadFolderPath, finalImagesFolderName);
