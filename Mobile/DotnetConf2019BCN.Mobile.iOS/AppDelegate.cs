...
using DotnetConf2019BCN.Mobile.IOS.Features.Scanning;
using DotnetConf2019BCN.Mobile.IOS.Features.Scanning.Photo;
using TouchTracking.iOS;
using UIKit;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;

[assembly: ResolutionGroupName(nameof(DotnetConf2019BCN))]

namespace DotnetConf2019BCN.Mobile.IOS
{
