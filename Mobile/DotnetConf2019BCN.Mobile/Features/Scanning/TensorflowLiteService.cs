...
namespace DotnetConf2019BCN.Mobile.Features.Scanning
{
    public class TensorflowLiteService
    {
        ...
        //public readonly string LabelFilename = TFFolder + "labels.txt";
        //public readonly string ModelFilename = TFFolder + "model.tflite";
